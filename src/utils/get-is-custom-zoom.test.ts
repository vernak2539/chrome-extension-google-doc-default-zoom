...
describe("getIsCustomZoom", () => {
  describe("Docs", () => {
    ...
    test.each(DOCS_ZOOM_VALUES)("should return false if predefined value (%i)", (value) => {
  ...
  describe("Sheets", () => {
    ...
    test.each(SHEETS_ZOOM_VALUES)("should return false if predefined value (%i)", (value) => {
